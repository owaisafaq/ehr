...
$app->group(['prefix' => 'api'], function () use ($app) {
    ...
    $app->get('add_inventory','App\Http\Controllers\InventoryAPIController@add_stock');
    $app->get('delete_inventory','App\Http\Controllers\InventoryAPIController@delete_stock');
    $app->get('update_inventory','App\Http\Controllers\InventoryAPIController@update_stock');
